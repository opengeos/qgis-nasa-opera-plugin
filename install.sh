#!/bin/bash
# Installation script for NASA OPERA QGIS Plugin
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --name, -n NAME   Plugin folder name (default: nasa_opera)"
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    echo "Please manually copy the nasa_opera folder to your QGIS plugins directory."
    exit 1
fi
...
if [[ "$REMOVE" == true ]]; then
    ...
    echo "  3. Enable 'NASA OPERA'"
    echo ""
    echo "Prerequisites:"
    echo "  Make sure you have the following Python packages installed:"
    echo "    pip install earthaccess geopandas shapely pandas"
    echo ""
    echo "  You also need a NASA Earthdata account:"
