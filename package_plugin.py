#!/usr/bin/env python3
"""
Package the NASA OPERA QGIS plugin for upload to the official QGIS plugin repository.

This script creates a zip file with the following characteristics:
- Root folder named 'nasa_opera'
...
Examples:
    ...
    python package_plugin.py --name nasa_opera
"""
...
def package_plugin(
    ...
    Args:
        source_dir: Path to the nasa_opera directory
        output_path: Optional path for the output zip file
        target_name: Name for the root folder in the zip (default: 'nasa_opera')
...
def main():
    parser = argparse.ArgumentParser(
        description="Package NASA OPERA QGIS plugin for repository upload",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output path for the zip file (default: nasa_opera-{version}.zip in the same folder as this script)",
    )
    parser.add_argument(
        "--source",
        "-s",
        type=Path,
        default=None,
        help="Source directory (default: nasa_opera in the same folder as this script)",
    )
    parser.add_argument(
        "--name",
        "-n",
        type=str,
        default="nasa_opera",
        help="Target plugin name for the zip root folder (default: nasa_opera)",
    )
    parser.add_argument(
        "--no-version",
        action="store_true",
    ...
    source_dir = args.source if args.source else script_dir / "nasa_opera"
