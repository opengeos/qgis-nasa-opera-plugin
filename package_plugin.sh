...
#   ./package_plugin.sh --name nasa_opera        # Custom plugin name
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "Options:"
            echo "  --name, -n NAME       Plugin name for zip folder (default: nasa_opera)"
...
echo "Packaging NASA OPERA QGIS Plugin"
echo "================================"
